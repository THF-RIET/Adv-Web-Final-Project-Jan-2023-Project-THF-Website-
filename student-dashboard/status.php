        ...
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item"  style="background-color: #043C8B;">
                <a class="nav-link text-dark" href="status.php?cnic=<?php echo $getCNIC ?>&userName=<?php echo $userName ?>">
                    ...
                    <span style="color: white;">Status</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
                ...
                <div class="container-fluid">
                    <section class="course-section" style="overflow: hidden;"> 
                        <div class="card course-card">
                            <div class="card-body cours">
                                <img  src="./images/pending.png" alt="icon" style="width: 4rem;">
                                <br><br>
                              <h5 class="card-title text-center" style="color:#043C8B"> ADMISSION Status</h5>
                              <h3 style="color: green;">Pending</h3>
                            </div>
                            <br><br>
                          </div>
                       </div>
