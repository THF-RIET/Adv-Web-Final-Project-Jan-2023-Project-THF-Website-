        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <section class="home-section bgcolor">
                        <div class="box1">
                          <H1 class="hgd" style="overflow: hidden;">ADMISSION TEST</H1>
                          <div class="box2" >
                            <p>Please note that the Admission Test will consist of four sections: 
                              1. English <br>
                              2. General Knowledge <br>
                              3. Mathematics <br>
                              4. Trade Questions. <br> <br>
                              Once you start the test, it cannot be undone, and you cannot go back or stop the test. The test is timed and must be completed in one attempt within a time limit of 100 minutes. Therefore, please ensure that you are well-prepared and have adequate time available before starting the test.</p>
                          </div>
                        <a href="quiz.php?cnic=<?php echo $getCNIC?>"><button type="button" class="btn btn-primary">Start</button></a>
                        </div><!---- BOX 1 END ----->
