...
$selectStmt = "SELECT courseName FROM student_enrollments WHERE stdCNIC = '" . $getCNIC . "'";
...
$status="";
if($courseName!=""){
    $status="You're Currently enrolled in '".$courseName."' ";
}else{
    $status="You're not enrolled in any course ";
}
                    ...
                    <section class="course-section">
                        <div class="card course-card">
                            <div class="card-body cours">
                                <img  src="images/icon.PNG" alt="icon" style="width: 5rem;">
                                <br><br>
                              <h5 class="card-title text-center" style="color:grey; font-size:16px; font-weight:bold; line-height: 18px;"><?php echo $status ?> </h5>
                            </div>
                            <br><br>
                          </div>
                          <a href="enrollCourse.php?cnic=<?php echo $getCNIC?>" class="enroll-now btn btn-primary">Enroll Now</a>
                       </div>
                       <?php echo $error ?>
                <br><br><br>
                <!-- End of Page Wrapper -->
