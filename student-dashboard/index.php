...
<head>
    ...
    <title>THF -Student Portal</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <!-- <a class="dropdown-item" href="#">
                                    ...
                                    Remove setting and Activity Log
                                </a> -->
                ...
                <section class=" detail">
                    <h2><u> Admission Procedure </u></h2>

                    <ol>
                        <li>Complete your profile in the Profile Section. This step is essential as it allows us to get
                            to know you better and tailor our services to your specific needs. Once you have completed
                            your profile, you will be prompted to select your desired course, and a fee voucher will be
                            generated.
                        </li>

                        <li> Proceed to the Payment Section and submit your payment slip. This step is necessary to
                            confirm your enrollment in the selected course.</li>

                        <li> Navigate to the Admission Test Tab and attempt the online test. The admission test is a
                            crucial component of the enrollment process, as it allows us to assess your aptitude and
                            determine your eligibility for the selected course.</li>
                        <li>
                            Finally, please wait for your selection. Our team will review your data and inform you of
                            your enrollment status in due time. Please note that this process may take some time, but we
                            will keep you updated every step of the way.
                        </li>

                        <br>
                        <p class="colors"> Thank you for choosing our institute for your educational needs. We look
                            forward to helping
