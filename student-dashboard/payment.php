...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item" style="background-color:#043C8B">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="payment2">
                    <section class="course-section">
                        <div class="card course-card">
                            <div class="card-body cours" >
                                <img  src="./images/fee.png" alt="icon" style="width: 5rem;">
                                <br><br>
                              <h5 class="card-title text-center"> ADMISSION FEE</h5>
                            </div>
                            <br><br>
                          </div>
                       </div>
                ...
                <script>
                    ...
                    document.getElementById("payment2").addEventListener('click', () => {
                            window.location="admission_payment.php?cnic=<?php echo $getCNIC?>";
                    });
