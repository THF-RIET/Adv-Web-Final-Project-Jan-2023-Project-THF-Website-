        ...
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item"  style="background-color: #043C8B;">
                <a class="nav-link text-dark" href="interview.php?cnic=<?php echo $getCNIC ?>&userName=<?php echo $userName ?>">
                    <i class="fas fa-fw fa-chart-area text-light"></i>
                    <span style="color: white;">Interview</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <section class="course-section" >
                        <div class="card course-card" id="change" style="height: auto;">
                            <div class="card-body cours">
                                <img  src="./images/job-interview.png" alt="icon" style="width: 4rem; padding-top: 18px;">
                                <br><br>
                              <h3 class="card-title text-center" style="color: green; font-weight: bold;">Waiting</h3>
                              <p>
                                If your test is passed, you will receive and interview
                                call from the respected institute.
                              </p>
                            </div>
                            <br><br>
                          </div>
